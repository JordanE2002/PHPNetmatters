       ...
       <footer>
        <div class="container">
            <div class="footer-row">
                      ...
                      <!-- Random place holder iamges for now as i only recentlly found out the icons do not have to be exact match-->
                ...
                <div class="footer-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Data Rentention & Disposal Policy </a></li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <p>© Copyright Netmatters Ltd. 2025. All rights reserved - <a href="/sitemap">Sitemap</a></p>
            </div>
        </div>
